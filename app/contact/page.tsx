...
const Contact = () => {
 ...
 {/* Social Links */}
            <motion.div
              ...
              className="bg-slate-800 rounded-xl p-6 mt-20"
            >
          ...
          >
            ...
            >
              <div className="w-full h-[300px] sm:h-[350px] md:h-[400px] rounded-xl overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3319.57355641426!2d73.01071382695311!3d33.6941047!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38dfbf129a345dc9%3A0xa21e40956cae10dd!2sTravelwithmoeen!5e0!3m2!1sen!2s!4v1771049773337!5m2!1sen!2s"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <p className="text-slate-600 text-sm mt-3 text-center">Our Location</p>
            </motion.div>
          </motion.div>
        </div>
      </PageContainer>
